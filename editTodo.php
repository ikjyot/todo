...
if (isset($_SESSION['name'], $_SESSION['user_id'], $_SESSION['isLogged'])) {
  ...
  <div id="edit_todo" class="z-depth-4 hoverable">
    ...
    <form method="post" action="index.php" style="display: inline">
      ...
      <div class="input-field">
        <input class="datepicker" type='date' placeholder="Due Date" id="edit_due_date" value="<?php echo $result['due_date'] ?>" name="edit_due_date">
      </div>
      <div class="input-field">
        <input class="timepicker" type='time' placeholder="Due Time" id="edit_due_time" value="<?php echo $result['due_time'] ?>" name="edit_due_time">
      </div>
